 ...
 * 
 * 日期格式器 <br/>
 * 该格式器不是线程安全的，在每个线程中使用lejinwangDateFormat时都应该使用lejinwangDateFormat的相关getInstance方法获取。<br/>
 * 
 * 试图将当前线程中获取的lejinwangDateFormat实例传给另一个线程使用，可能会出现并发问题。
 * <p>
 * 
 * 例如：
 * 
 * <pre>
 * Date date = lejinwangDateFormat.getInstance(&quot;yyyy-MM-dd HH.mm.ss&quot;).parse(&quot;2011-06-22 19.49.28&quot;);
 * String str = lejinwangDateFormat.getInstance(&quot;yyyy-MM-dd HH.mm.ss&quot;).format(date);
 * </pre>
 * 
 * 
 * @since v1.1
...
public class YZYDateFormat
{
	...
	/**
	 * 
	 * 构造函数，设成了私有来强制用户使用lejinwangDateFormat.getXXInstance()等方法获取格式器
	 * 
	 * @param dateFormat
	 * @param locale
	 * 
