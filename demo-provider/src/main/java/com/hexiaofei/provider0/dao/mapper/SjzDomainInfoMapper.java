...
public interface SjzDomainInfoMapper {
    ...
    @Insert({
        ...
        "#{lastCrawlTime,jdbcType=TIMESTAMP}, #{crawlUseTime,jdbcType=TIMESTAMP}, ",
    ...
    @Results({
        ...
        @Result(column="crawlUseTime", property="crawlUseTime", jdbcType=JdbcType.TIMESTAMP),
    ...
    @Update({
        ...
        "set domainName = #{domainName,jdbcType=INTEGER},",
          ...
          "crawlUseTime = #{crawlUseTime,jdbcType=TIMESTAMP},",
