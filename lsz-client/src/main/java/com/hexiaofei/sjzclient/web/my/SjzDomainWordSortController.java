...
@Controller
public class SjzDomainWordSortController extends MyBaseController implements BaseController<SjzDomainWordSort> {
    ...
    @Override
    public ResultVo<SjzDomainWordSort> add(HttpServletRequest request, SjzDomainWordSort sjzDomainWordSort) {
        return null;
    }
